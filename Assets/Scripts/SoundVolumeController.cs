...
public class SoundVolumeController : MonoBehaviour
{
    ...
    [Header("Keys")]
    [SerializeField] private string saveVolumeKey = "MUSIC_VALUE";

    [Header("Tags")]
    [SerializeField] private string sliderTag = "VOLUME_SLIDER";
    [SerializeField] private string textVolumeTag = "VOLUME_VALUE";
